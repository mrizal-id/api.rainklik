        ...
        <div class="row" id="links">
            ...
            <div class="col-md-3 col-xl-2 pb-2 pb-md-0">
                ...
                <div class="collapse d-md-block" id="categories" data-bs-parent="#links">
                    <ul class="nav flex-column pb-2 pb-md-0">
                        <li class="nav-item">
                            <a class="nav-link fw-normal px-0 py-1" href="#">Ibu & Anak</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link fw-normal px-0 py-1" href="#">Rumah Tangga</a>
                        </li>
                        <li class="nav-item">
            ...
            <div class="col-md-3 pb-2 pb-md-0">
                ...
                <div class="collapse d-md-block" id="showroom" data-bs-parent="#links">
                    <ul class="nav flex-column pb-3">
                        <li class="nav-item">
                            <a class="nav-link fw-normal px-0 py-1" href="#">1501 Main St, Ste 50<br>Tewksbury
                                MA 01876</a>
                        </li>
                        <li class="nav-item">
                        ...
                        <li class="nav-item">
                            <a class="nav-link fw-normal px-0 py-1"
                                href="+15262200459">+1&nbsp;526&nbsp;220&nbsp;0459</a>
                        </li>
                    </ul>
            ...
            <div class="col-12 col-xl-3 mt-md-2 mt-xl-0 pt-2 pt-md-4 pt-xl-0">
                ...
                <div class="d-flex d-xl-block d-xxl-flex">
                    <a class="btn btn-secondary px-3 py-2 mt-3 me-3" href="#">
                        <img class="mx-1" src="/images/footer/appstore-light.svg" width="120" alt="App Store">
                    </a>
                    <a class="btn btn-secondary px-3 py-2 mt-3" href="#">
                        <img class="mx-1" src="/images/footer/googleplay-light.svg" width="119"
                            alt="Google Play">
                    </a>
                </div>
            </div>
        ...
        <div class="d-sm-flex align-items-end justify-content-between border-bottom mt-2 mt-sm-1 pt-4 pt-sm-5">
            ...
            <div class="dropdown mb-4">
                <button class="btn btn-outline-secondary dropdown-toggle px-4" type="button"
                    ...
                    <svg class="me-2" xmlns="http://www.w3.org/2000/svg" width="18" alt="Indonesia / IDR"
                        viewBox="0 0 32 32">
        ...
        <div class="d-sm-flex align-items-center pt-4">
            <div class="d-sm-flex align-items-center pe-sm-2">
                <a class="navbar-brand d-inline-flex align-items-center me-sm-5 mb-4 mb-sm-0" href="index.html">
                    ...
                    <span class="text-light opacity-90">{{ config('app.name') }}</span>
                </a>
            ...
            <img class="ms-sm-auto" src="/images/footer/footer-cards.png" width="187" alt="Accepted cards">
        </div>
    </div>
</footer>
