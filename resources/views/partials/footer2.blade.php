<footer class="footer bg-dark py-5" data-bs-theme="dark">
    <div class="container pt-md-2 pt-lg-3 pt-xl-4">
        <div class="row pb-5 pt-sm-2 mb-lg-2">
            <div class="col-md-4 col-lg-3 pb-2 pb-md-0 mb-4 mb-md-0">
                <a class="navbar-brand py-0 mb-3 mb-md-4" href="index.html">
                    ...
                    <span class="text-white opacity-90">RainKlik</span>
                </a>
                <p class="text-body fs-sm pb-2 pb-md-3 mb-3">Tellus non diam morbi quam vel venenatis proin sed. Dolor
                ...
                <div class="row row-cols-1 row-cols-sm-3">
                    ...
                    <div class="col">
                        ...
                        <a class="btn btn-secondary px-3 py-2 mt-3 me-3 me-md-0" href="#">
                            <img class="mx-1 d-dark-mode-none" src="/images/appstore-dark.svg" width="120"
                                alt="App Store">
                            <img class="mx-1 d-none d-dark-mode-block" src="/images/appstore-light.svg" width="120"
                                alt="App Store">
                        </a>
                        <a class="btn btn-secondary px-3 py-2 mt-3 me-3 me-md-0" href="#">
                            <img class="mx-1 d-dark-mode-none" src="/images/googleplay-dark.svg" width="119"
                                alt="Google Play">
                            <img class="mx-1 d-none d-dark-mode-block" src="/images/googleplay-light.svg" width="119"
                                alt="Google Play">
                        </a>
                    </div>
                </div>
        ...
        <p class="nav fs-sm mb-0">
            ...
            <a class="nav-link fw-normal p-0 ms-1" href="/" target="_blank" rel="noopener">RainKlik</a>
        </p>
    </div>
</footer>
