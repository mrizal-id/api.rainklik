        ...
        <section class="card border-0 py-1 p-md-2 p-xl-3 p-xxl-4 mb-4">
            <div class="card-body">
                <div class="d-flex align-items-center mt-sm-n1 pb-4 mb-0 mb-lg-1 mb-xl-3">
                    ...
                    <a class="btn btn-sm btn-secondary ms-auto" href="{{ url('dashboard.profile.edit') }}">
                ...
                <div class="d-md-flex align-items-center">
                    <div class="d-sm-flex align-items-center">
                        <div class="rounded-circle bg-size-cover bg-position-center flex-shrink-0"
                            style="width: 80px; height: 80px; background-image: url(/images/no-image.jpg);">
                        </div>
                ...
                <div class="row py-4 mb-2 mb-sm-3">
                    ...
                    <div class="col-md-6 d-md-flex justify-content-end">
                        <div class="w-100 border rounded-3 p-4" style="max-width: 212px;">
                            <img class="d-block mb-2" src="{{ asset('/images/dashboard/gift-icon.svg') }}" width="24"
                                alt="Gift icon">
                ...
                <div class="alert alert-info d-flex mb-0" role="alert">
                    ...
                    <div class="ps-2">
                        ...
                        <a class="alert-link ms-1" href="account-settings.html">Go to settings!</a>
                    </div>
                </div>
                ...
                <div class="card h-100 border-0 py-1 p-md-2 p-xl-3 p-xxl-4">
                    <div class="card-body">
                        <div class="d-flex align-items-center mt-sm-n1 pb-4 mb-1 mb-lg-2">
                            ...
                            <a class="btn btn-sm btn-secondary ms-auto" href="{{ url('dashboard.user.edit') }}">
                                <i class="ai-edit ms-n1 me-2"></i>
                                Edit info
                            </a>
                        </div>
                        ...
                        <p class="mb-0"> {{ Auth::user()->country }}<br> {{ Auth::user()->state }},
                            {{ Auth::user()->city }}<br> {{ Auth::user()->postal_code }}</p>
                ...
                <div class="card h-100 border-0 py-1 p-md-2 p-xl-3 p-xxl-4">
                    <div class="card-body">
                        ...
                        <div class="alert alert-danger d-flex mb-0">
                            ...
                            <p class="mb-0">Your primary credit card expired on 01/04/2023. Please add a new card
                                or update this one.</p>
                        </div>
                    </div>
                </div>
            </section>
        ...
        <section class="card border-0 py-1 p-md-2 p-xl-3 p-xxl-4">
            <div class="card-body">
                ...
                <div class="accordion accordion-alt accordion-orders" id="orders">
                        ...
                        <div class="accordion-header">
                            <a class="accordion-button d-flex fs-4 fw-normal text-decoration-none py-3 collapsed"
                                ...
                                <div class="accordion-button-img d-none d-sm-flex ms-auto">
                                    <div class="mx-1">
                                        <img src="/images/no-image.jpg" width="48" alt="Product">
                                    </div>
                                </div>
                            </a>
                        </div>
                                                ...
                                                <td class="border-0 py-1 px-0">
                                                    <div class="d-flex align-items-center">
                                                        <a class="d-inline-block flex-shrink-0 bg-secondary rounded-1 p-md-2 p-lg-3"
                                                            ...
                                                            <img src="/images/no-image.jpg" width="110"
                                                                alt="Product">
                                                        </a>
                                                ...
                                                <td class="border-0 py-1 px-0">
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <div class="ps-3 ps-sm-4">
                                                            ...
                                                            <div class="text-body-secondary fs-sm me-3">Color:
                                                                <span class="text-dark fw-medium">Turquoise</span>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </td>
                                            ...
                                            <tr>
                                                <td class="border-0 py-1 px-0">
                                                    <div class="d-flex align-items-center"><a
                                                            ...
                                                            href="shop-single.html"><img src="/images/no-image.jpg"
                                                                width="110" alt="Product"></a>
                                                        <div class="ps-3 ps-sm-4">
                                                            <h4 class="h6 mb-2"><a href="shop-single.html">Ceramic
                                                                    flower pot</a></h4>
                                                            <div class="text-body-secondary fs-sm me-3">Color:
                                                                <span class="text-dark fw-medium">Gray
                                                                    concrete</span>
                                                            </div>
                                                        </div>
                                                    </div>
                    ...
                    <div class="accordion-item border-top mb-0">
                        <div class="accordion-header">
                            <a class="accordion-button fs-4 fw-normal text-decoration-none py-3 collapsed"
                                href="#orderThree" data-bs-toggle="collapse" aria-expanded="false"
                                aria-controls="orderThree">
                                <div class="d-flex justify-content-between w-100" style="max-width: 440px;">
                                    <div class="me-3 me-sm-4">
                                        <div class="fs-sm text-body-secondary">#34VB5540K83</div><span
                                            class="badge bg-primary bg-opacity-10 text-primary fs-xs">Delivered</span>
                                    </div>
                                    <div class="me-3 me-sm-4">
                                        <div class="d-none d-sm-block fs-sm text-body-secondary mb-2">Order date
                                        </div>
                                            ...
                                            <tr>
                                                <td class="border-0 py-1 px-0">
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <div class="ps-3 ps-sm-4">
                                                            <h4 class="h6 mb-2"><a href="shop-single.html">Candle
                                            ...
                                            <tr>
                                                <td class="border-0 py-1 px-0">
                                                    <div class="d-flex align-items-center">
                                                        <a class="d-inline-block flex-shrink-0 bg-secondary rounded-1 p-md-2 p-lg-3"
                                                            href="shop-single.html">
                                                            <img src="assets/img/shop/cart/02.png" width="110"
                                                                alt="Product">
                                                        </a>
                                                        <div class="ps-3 ps-sm-4">
                                                            <h4 class="h6 mb-2">
                                                                <a href="shop-single.html">Exquisite glass vase
                                                                </a>
                                                            </h4>
                                                            <div class="text-body-secondary fs-sm me-3">Color:
                                            ...
                                            <tr>
                                                <td class="border-0 py-1 px-0">
                                                    <div class="d-flex align-items-center">
                                                        <a class="d-inline-block flex-shrink-0 bg-secondary rounded-1 p-md-2 p-lg-3"
                                                            href="shop-single.html">
                                                            <img src="assets/img/shop/cart/07.png" width="110"
                                                                alt="Product">
                                                        </a>
                                                        <div class="ps-3 ps-sm-4">
                                                            <h4 class="h6 mb-2">
                                                            ...
                                                            <div class="text-body-secondary fs-sm me-3">Color:
                                                                <span class="text-dark fw-medium">White
                                                                    marble</span>
                                                            </div>
                                                        </div>
                                                    </div>
